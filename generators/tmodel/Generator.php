...
namespace wokster\ltewidgets\generators\tmodel;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'This generator generates an extended ActiveRecord class for the specified database table.';
    }
